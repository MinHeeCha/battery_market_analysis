...
def test_llm_connection():
    ...
    try:
        ...
        raise AssertionError(f"Failed to initialize LLM client: {e}") from e
    ...
    try:
        ...
        if not result:
            pytest.skip("OpenAI API is unreachable from the current environment")
        print("  ✓ Connection test PASSED")
    except pytest.skip.Exception:
        raise
    except Exception as e:
        pytest.skip(f"OpenAI API connection unavailable: {e}")
    ...
    try:
        ...
        pytest.skip(f"Prompt test skipped because OpenAI API is unavailable: {e}")
    ...
    try:
        ...
        pytest.skip(f"Korean prompt test skipped because OpenAI API is unavailable: {e}")
