...
def test_context_formatting():
    ...
    try:
        ...
        raise AssertionError(f"Template formatting failed: {e}") from e
    ...
    if "요청 배경" in user_prompt and context_str in user_prompt:
        ...
        raise AssertionError("Context not found in prompt")
    ...
    if "검색 결과" in user_prompt and "배터리 시장 규모" in user_prompt:
        ...
        raise AssertionError("Search results not found in prompt")
